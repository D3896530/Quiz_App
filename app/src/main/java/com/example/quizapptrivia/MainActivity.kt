...
class MainActivity : AppCompatActivity() {
    ...
    private fun loadData() {
        ...
        progressDialog.show()
            ...
            val categoryScience: List<String> = listOf("17", "18", "19", "30")
            val jsonObjectRequest =
                object : JsonObjectRequest(url, com.android.volley.Response.Listener {
                    ...
                    for (i in 0..triviaCategories.length().minus(1)){
                        ...
                        if (categoryScience.contains(id)) { // Check if the id is in the categoryScience list
                            val categoryInfo = CategoryInfo(id.toString(), categoryName)
